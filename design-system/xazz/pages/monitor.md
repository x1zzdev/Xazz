...
Overrides `design-system/xazz/MASTER.md` only for the Monitor canvas view. Inherits
`design-system/xazz/pages/workspace.md` in full, including its dark token column, no-glow rule,
