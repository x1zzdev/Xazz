...
| `model {}` + `train()` | Burn DL model declaration & training (Adam + MSE, validation split, early stopping, hyperparameter sweep with `metric:` selection and `sort:`/`top:` report ordering, checkpoints) | Stable |
