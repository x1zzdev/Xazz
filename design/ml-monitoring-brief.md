...
1. `ui-prototype/src/data.js` models five preprocessing stages only
...
2. `README.md` §2 and §"Real-Time Monitoring" promise differential-privacy budget tracking and
   resource-efficiency monitoring. `design/state-contract.md` §3.1 correctly classifies both as
...
- `design/state-contract.md` §7: Burn, DP, policy, sLM, monitoring values must not be filled with
